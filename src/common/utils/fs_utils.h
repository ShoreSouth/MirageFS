...
static inline bool fs_range_valid2(uint64_t offset, uint64_t len,
                                   uint64_t max_size)
{
    if (len == 0)
        return false;
...
static inline bool fs_range_overlap(uint64_t o1, uint64_t l1, uint64_t o2,
                                    uint64_t l2)
{
    uint64_t e1 = o1 + l1;
    uint64_t e2 = o2 + l2;
...
static inline fs_error_t fs_trim_to_aligned(uint64_t *offset, uint64_t *len,
                                            uint64_t align)
{
...
static inline fs_error_t fs_trim_to_aligned_ex(uint64_t *offset, uint64_t *len,
                                               uint64_t align,
                                               fs_trim_info_t *info)
{
