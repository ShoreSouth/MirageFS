...
static const char *g_namei_sub_names[] = {
        [NAMEI_SUB_NONE] = "NONE",     [NAMEI_SUB_INIT] = "INIT",
        [NAMEI_SUB_CTX] = "CTX",       [NAMEI_SUB_PATH] = "PATH",
        [NAMEI_SUB_WALK] = "WALK",     [NAMEI_SUB_LOOKUP] = "LOOKUP",
        [NAMEI_SUB_PARENT] = "PARENT", [NAMEI_SUB_OP] = "OP",
};
