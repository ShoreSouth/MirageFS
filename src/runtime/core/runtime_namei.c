                          ...
                          fs_flags_t flags, fops_object_result_t *out)
{
    ...
    return namei_create(&ctx, path, attr, flags, (out != NULL) ? out : &tmp);
}
                         ...
                         fs_flags_t flags, fops_object_result_t *out)
{
    ...
    return namei_mkdir(&ctx, path, attr, flags, (out != NULL) ? out : &tmp);
}
                           ...
                           fs_flags_t flags, fops_object_result_t *out)
{
    ...
    return namei_symlink(&ctx, target, linkpath, flags,
                         (out != NULL) ? out : &tmp);
}
