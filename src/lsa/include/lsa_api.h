 ...
 */
    ...
    lsa_ret_t lsa_name_to_handle_at(int dirfd, const char *path,
                                    ...
                                    int32_t *mount_id, int flags);

    lsa_ret_t lsa_open_by_handle_at(int mount_fd,
 ...
 */
    ...
    lsa_ret_t lsa_lookup(int dirfd, const char *name, fs_flags_t flags,
                         int *fd);

    lsa_ret_t lsa_create(int dirfd, const char *name, fs_flags_t flags,
                         mode_t mode, int *fd);

    lsa_ret_t lsa_mkdir(int dirfd, const char *name, fs_flags_t flags,
                        mode_t mode);
    ...
    lsa_ret_t lsa_mknod(int dirfd, const char *name, fs_type_t type,
                        mode_t mode, const lsa_device_t *device);
 ...
 */
    lsa_ret_t lsa_write_full(int fd, const void *buf, size_t size,
                             size_t *actual);
 ...
 */
    ...
    lsa_ret_t lsa_dir_iter_next_plus(lsa_dir_iter_t *iter,
                                     lsa_dirent_plus_t *entry);

    lsa_dir_cookie_t lsa_dir_iter_get_cookie(const lsa_dir_iter_t *iter);
 ...
 */
    ...
    lsa_ret_t lsa_setxattr(int fd, const char *name, const void *value,
                           size_t size, fs_flags_t flags);

    lsa_ret_t lsa_getxattr(int fd, const char *name, void *value, size_t size,
                           size_t *actual);

    lsa_ret_t lsa_listxattr(int fd, char *list, size_t size, size_t *actual);

    lsa_ret_t lsa_removexattr(int fd, const char *name);
 ...
 */
    ...
    lsa_ret_t lsa_statfs(int fd, struct statfs *st);

    lsa_ret_t lsa_syncfs(int fd);
