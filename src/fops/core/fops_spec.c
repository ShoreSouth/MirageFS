...
static const fops_op_spec_t g_fops_op_specs[] = {
        ...
        {FS_OP_CREATE, "create",
         FS_FLAG_REPLACE | FS_FLAG_EXCLUSIVE | FS_FLAG_NOFOLLOW | FS_FLAG_SYNC |
                 FS_FLAG_DIRECT | FS_FLAG_REGULAR | FS_FLAG_TRUNCATE |
                 FS_FLAG_APPEND,
         FS_FLAG_REPLACE, FS_FLAG_EXCLUSIVE, false, false, true, true},
        {FS_OP_MKDIR, "mkdir", FS_FLAG_EXCLUSIVE | FS_FLAG_DIRECTORY,
         FS_FLAG_NONE, FS_FLAG_NONE, false, false, true, true},
        {FS_OP_MKNOD, "mknod", FS_FLAG_EXCLUSIVE, FS_FLAG_NONE, FS_FLAG_NONE,
         false, false, true, true},
        {FS_OP_UNLINK, "unlink", FS_FLAG_NOFOLLOW | FS_FLAG_REGULAR,
         FS_FLAG_NONE, FS_FLAG_NONE, false, false, true, true},
        {FS_OP_RMDIR, "rmdir", FS_FLAG_DIRECTORY, FS_FLAG_NONE, FS_FLAG_NONE,
         false, false, true, true},
        {FS_OP_RENAME, "rename", FS_FLAG_REPLACE | FS_FLAG_EXCLUSIVE,
         FS_FLAG_REPLACE, FS_FLAG_EXCLUSIVE, false, false, true, true},
        {FS_OP_LINK, "link", FS_FLAG_EXCLUSIVE, FS_FLAG_NONE, FS_FLAG_NONE,
         false, false, true, true},
        {FS_OP_SYMLINK, "symlink", FS_FLAG_EXCLUSIVE, FS_FLAG_NONE,
         FS_FLAG_NONE, false, false, true, true},
        {FS_OP_READLINK, "readlink", FS_FLAG_NOFOLLOW, FS_FLAG_NONE,
         FS_FLAG_NONE, false, false, true, true},
        {FS_OP_OPEN, "open",
        ...
        {FS_OP_CLOSE, "close", FS_FLAG_NONE, FS_FLAG_NONE, FS_FLAG_NONE, false,
         false, false, false},
        {FS_OP_GETHANDLE, "gethandle", FS_FLAG_NONE, FS_FLAG_NONE, FS_FLAG_NONE,
        ...
        {FS_OP_READDIR, "readdir", FS_FLAG_DIRECTORY, FS_FLAG_NONE,
         FS_FLAG_NONE, false, true, false, false},
        {FS_OP_READDIRPLUS, "readdirplus", FS_FLAG_DIRECTORY, FS_FLAG_NONE,
         FS_FLAG_NONE, false, true, false, false},
        {FS_OP_GETATTR, "getattr", FOPS_FLAG_TYPE_MASK, FS_FLAG_DIRECTORY,
         FS_FLAG_REGULAR, false, true, false, false},
        {FS_OP_SETATTR, "setattr", FOPS_FLAG_TYPE_MASK, FS_FLAG_DIRECTORY,
         FS_FLAG_REGULAR, false, true, false, false},
        {FS_OP_ACCESS, "access", FOPS_FLAG_TYPE_MASK, FS_FLAG_DIRECTORY,
         FS_FLAG_REGULAR, false, true, false, false},
        {FS_OP_READ, "read", FS_FLAG_NONE, FS_FLAG_NONE, FS_FLAG_NONE, false,
         false, false, false},
        {FS_OP_WRITE, "write", FS_FLAG_NONE, FS_FLAG_NONE, FS_FLAG_NONE, false,
         false, false, false},
        {FS_OP_TRUNCATE, "truncate", FOPS_FLAG_TYPE_MASK, FS_FLAG_DIRECTORY,
         FS_FLAG_REGULAR, false, true, false, false},
        {FS_OP_GETXATTR, "getxattr", FS_FLAG_NONE, FS_FLAG_NONE, FS_FLAG_NONE,
         false, true, false, true},
        {FS_OP_SETXATTR, "setxattr", FS_FLAG_REPLACE | FS_FLAG_EXCLUSIVE,
         FS_FLAG_REPLACE, FS_FLAG_EXCLUSIVE, false, true, false, true},
        {FS_OP_LISTXATTR, "listxattr", FS_FLAG_NONE, FS_FLAG_NONE, FS_FLAG_NONE,
         false, true, false, false},
        {FS_OP_REMOVEXATTR, "removexattr", FS_FLAG_NONE, FS_FLAG_NONE,
         FS_FLAG_NONE, false, true, false, true},
        {FS_OP_STATFS, "statfs", FS_FLAG_NONE, FS_FLAG_NONE, FS_FLAG_NONE,
         false, true, false, false},
        {FS_OP_SYNCFS, "syncfs", FS_FLAG_NONE, FS_FLAG_NONE, FS_FLAG_NONE,
         false, true, false, false},
};
...
const fops_op_spec_t *fops_op_spec_get(fs_op_t op)
{
    ...
    for (i = 0U; i < (sizeof(g_fops_op_specs) / sizeof(g_fops_op_specs[0]));
         i++)
    {
